...
//
// echo 'LINKEDIN_CLIENT_ID=781iff51lr3vuj' >> .env;
// echo 'LINKEDIN_CLIENT_SECRET=nWxSyCzaR4vx1fw7' >> .env

$dotenv = new Dotenv\Dotenv(dirname(__DIR__) . DIRECTORY_SEPARATOR . 'examples/');
$dotenv->load();
